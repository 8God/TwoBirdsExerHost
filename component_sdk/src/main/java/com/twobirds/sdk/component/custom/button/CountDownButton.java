package com.twobirds.sdk.component.custom.button;
...
public class CountDownButton extends android.support.v7.widget.AppCompatButton {
    ...
    private void initCountDownTextColor(Context context, AttributeSet attrs) {
        ...
        int textColor = 0;
        try {
            countDownTextColor = array.getColor(R.styleable.CountDownButton_countDouwn_textColor, getResources().getColor(R.color.disabled_text_color));
