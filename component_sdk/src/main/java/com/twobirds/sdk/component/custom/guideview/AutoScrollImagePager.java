...
package com.twobirds.sdk.component.custom.guideview;
...
public class AutoScrollImagePager extends RelativeLayout {
     ...
     *
     * @param direction
     *            {@link #LEFT} 或者 {@link #RIGHT}, 默认是{@link #RIGHT}
     */
     ...
     *
     * @param transformer
     *            Page Transformer that will modify each page's animation
     *            properties.
     */
     ...
     *            true if the supplied Page Transformer requires page views to
    ...
    private class ImagePagerAdapter extends PagerAdapter {
        ...
        public ImagePagerAdapter(List<View> imageViewList) {
            ...
            if (null != imageViewList) {
                ...
                canCycle = (isCycle && (count >= 3)) ? true : false; /* 少于3个出现BUG */
            }
        }
        ...
        public void destroyItem(ViewGroup container, int position, Object object) {
            //         container.removeView(imageViewList.get(getPosition(position)));
        }
